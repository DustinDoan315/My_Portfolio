...
export default function Formatter() {
  ...
  return (
    <div className="min-h-screen flex items-center rounded-lg justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-400 p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="mb-4 block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-100 file:text-purple-700 hover:file:bg-purple-200"
          />
          <button
            type="submit"
            disabled={isLoading}
